...
\item \tk{In particular, providing the IRS with more detailed information on taxpayers’ business income sources, including sole proprietorships, partnerships, S corporations, estates and trusts, as well as rents and royalties — would help them to reduce tax evasion.}
...
\end{itemize}
\subsubsection*{Information Text: Old Version}
The following explanations are used as subtitles and audio for an animated video.
\begin{itemize}
\item One problem governments face is the loss of tax revenue due to tax evasion.
\item Most of taxpayers file their taxes correctly. That means they honestly report their tax-relevant information and therefore pay their fair share in taxes. 
\item However, there is a significant share of people that deliberately hide some of their income or wealth from the tax authorities. 
\item This means they misreport when filing their taxes and therefore end up paying less taxes than they're supposed to. 
\item Due to misreporting and tax evasion, the government loses a considerable share of potential tax money.
\item Out of \$4.6 trillion in taxes, the IRS collects only 87\%. The missing 13\% add up to \$606 billion that never reach government revenue. 
\item The tax authorities have a number of options to combat tax evasion. 
\item One way is to conduct tax audits on taxpayers. 
\item That means they investigate tax returns and taxpayers in detail. Increasing their tax audit activities can help the IRS to detect and reduce tax evasion. 
\item Another way to combat tax evasion is third-party reporting. 
\item Third-party reporting means that the tax authority uses information that domestic firms and institutions directly report to the tax authority. 
\item For example, employers report to the tax administration how much they pay their employees in wages. 
\item Another example is that a bank automatically informs the tax authority about interest and dividend payments. 
...
\item Due to third-party reporting the IRS has information about most of the bank accounts held in the US. 
\item But there is a small share of taxpayers that also holds bank accounts in other countries. 
\item Often these banks also report information to their local tax administration. 
\item However, without special agreements, this information does not reach the US tax administration. 
\item This is why many countries agreed to share this tax-relevant data with each other. 
...
\item Therefore, increasing the number of countries with which the US cooperates on data sharing helps to reduce overall tax evasion. 
\item This would enable the US to collect more tax revenue.
\item We have set out three ways in which the IRS could reduce tax evasion. 
\item First, it could conduct more tax audits. Second, it could increase the level of third-party reporting. 
\item Finally, it could exchange more tax-relevant information with other countries. 
\end{itemize}
...
\item When some people don't pay their taxes, it's not just the government that loses money, it affects all taxpayers. 
\item This is because in response to lower resources, the government either \tk{has to} raise taxes or lower public services. Either way, all taxpayers are affected. 
\item The tax authorities have a number of options to combat tax evasion. [\textit{From here on, the evasion: revenue and evasion: inequality treatments are identical.}]
\item One way is to conduct tax audits on taxpayers. 
\item That means they investigate tax returns and taxpayers in detail. Increasing their tax audit activities can help the IRS to detect and reduce tax evasion. 
\item Another way to combat tax evasion is third-party reporting. 
...
\begin{itemize}
    ...
    \item Filing taxes can be a tedious process. And, it can also be expensive.
    \item According to the IRS, US taxpayers need an average of 13 hours and \$250 to file their taxes. 
    \item This is because many taxpayers either pay for advice or pay someone else to prepare their tax return.
    \item Additionally, those taxpayers that file taxes themselves often use costly tax software to file their returns.
    \item Such software provides guidance through the tax formulas and explains which deductions might apply.
    \item It provides field-by-field advice including understandable explanations and examples. 
    \item In the U.S., most taxpayers pay commercial providers for access to tax software. This can be expensive, particularly if your returns are complicated.
    \item However, tax software could potentially be free.
    \item The IRS could provide its citizens with free access to tax software. Many other countries already do this.
    \item Not only could there be free tax software, but the IRS could also offer pre-populated tax returns. 
    \item This means that the tax returns are pre-filled with information the tax administration already has.
    \item To submit the tax return, some of the taxpayers would only need to enter missing information such as deductible expenses that the IRS does not know of. But many taxpayers would only have to briefly confirm that the pre-populated return is correct.
    \item This would save time, effort and it would reduce the potential of making mistakes when filing. 
    ...
    \item Local governments, for example, keep track of who owns a house and how much property tax they pay. However, they do not send this information to the IRS. 
    \item Having access to these data would enable the IRS to pre-populate even more tax returns. 
    \item To summarize the most important steps towards pre-populating tax returns: First, the speed of existing data transfer has to be increased. Second, additional tax-relevant data has to be reported by third parties.
\end{itemize}

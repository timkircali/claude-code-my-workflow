...
%\end{itemize}
\item Tax administrations have a number of options to combat tax evasion.
...
\item Another example is that the bank automatically informs the tax authority about interest and dividend payments of assets held by a person in a bank.
...
\end{itemize}
\item International information exchange is also very effective in reducing tax evasion. %In 2017-2018, more than 100 countries started to cooperate internationally to combat offshore tax evasion. 
...
\item This automatic exchange of information has proven to be very effective. For example, in Denmark, the automatic exchange of information has led to a reduction of the offshore tax evasion of about 70\%. 
